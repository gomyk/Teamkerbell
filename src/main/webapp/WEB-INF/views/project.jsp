...
<body class="hold-transition skin-blue sidebar-mini" ng-controller="projectController">
<div class="wrapper">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div id="inviteForm" class="sidebar-form">
                            <div class="input-group">
                                <input type="text" id="i$nviteId" ng-model="inviteId" class="form-control"
                                       placeholder=" User ID Search...">
                                <span class="input-group-btn">
                	<button type="button" class="btn btn-flat" ng-click="search()"><i
                            ...
                            <div id="user" ng-show="invitebool">

                                <div class="box box-primary" style="width:70%; margin-left:15%; margin-top:5%">
                                    <div class="box-body box-profile"><img
                                            class="profile-user-img img-responsive img-circle"
                                            alt="User profile picture" ng-src="../{{inviteUser.img}}">
                                        <h3
                                                class="profile-username text-center" ng-bind="inviteUser.userId"></h3>
                                        <p class="text-muted text-center" ng-bind="inviteUser.name"></p>
                                        <a href="#" class="btn btn-primary btn-block"
                                           ng-click="invite()"><b>Invite</b></a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    myApp.controller('projectController', function ($scope, $http) {
        $scope.invite = function(){
            ...
            $http(req).success(function(response){
                socket.emit('invite',{userIdx:response.toString()});
            });
        }
        ...
        $scope.search = function () {
            ...
            $http(req)
                    .success(function (data) {
                        $scope.invitebool = true;
                        $scope.inviteUser=data;
                    })
        }

        $scope.makeTodolist= function(){
            var data = {
                projectIdx: projectIdx,
